...
public class UploadList1 extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		try{
			...
			if(c==0){
				...
				rs=stmt.executeQuery("select MAX(list_id) from global_list");
				while(rs.next()){
					c=rs.getInt("MAX(list_id)");
				}
				rs.close();
				list_id= ++c;
			}	
			PreparedStatement pstmt;
			pstmt = con.prepareStatement("insert into global_list values(?,?,'"+creat_date+"')");
			...
			out.println("<tr>");
			out.println("<td width='100%'><font face='Verdana' color='#FFFFFF'><small><strong>Making a new List..</strong></small></font></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("</div><div align='right'>");
			...
			out.println("<form method='POST' action='UploadNewList' ENCTYPE='multipart/form-data'>");
			out.println("<table border='0' width='80%' cellspacing='0' cellpadding='0' height='161' <tr>");
			out.println("<tr>");
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><div align='center'><center><p><font face='Verdana' color='#000080'><small><br><br><br>Successfully Created a New List: "+list_name+"</small></font></td>");
			out.println("</tr>");
			
			out.println("<tr align='center'>");
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><font face='Verdana' color='#000080'><small><center><br>Now Browse an CSV file with 'First Name' & 'Email' fields<br></small></font></td>");
			out.println("</tr>");
		
			out.println("<tr align='center'>");
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><div align='center'><center> <input type='file' name='csv'>	</td>");
			out.println("</tr>");							
			out.println("<tr align='center'>");
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><div align='center'><center><br><input type='submit' value='Upload List' name='B1' style='background-color: rgb(196,196,255); color: rgb(0,0,0); border: 1px solid rgb(0,0,128)'> &nbsp; </td>");
			out.println("</tr>");
			out.println("</table>");
