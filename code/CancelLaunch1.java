...
public class CancelLaunch1 extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		try{
            ...
            stmt.executeUpdate("Update mail_campaign set camp_launch=0 where camp_id="+camp_id);
			out.println("<html>");
			out.println("<head>");
			...
			out.println("<tr>");
			out.println("<td width='100%'><font face='Verdana' color='#FFFFFF'><small><strong>Cancelled Campaign Launch..</strong></small></font></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("</div><div align='right'>");
			...
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><font face='Verdana' color='#000080'><small><center><br>Campaign Launch Successfully Cancelled.<br><br></small></font></td>");
			out.println("</tr>");
			out.println("<tr align='center'>");
