...
public class ScheduleMail2 extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		String temp_month=req.getParameter("month");
		String temp_day=req.getParameter("day");
		String temp_year=req.getParameter("year");
		String temp_hour=req.getParameter("hour");
		String temp_min=req.getParameter("min");
        ...
        try{
			...
			month=Integer.parseInt(temp_month);	
			day=Integer.parseInt(temp_day);	
			year=Integer.parseInt(temp_year);	
			hour=Integer.parseInt(temp_hour);	
			min=Integer.parseInt(temp_min);				
		}
		catch(Exception e){
			out.println("<H2>Invalid Schedule Date or Timing</H2>");
		  	out.println("<a href='javascript:history.go(-1)'>Click Here</a>  to go back to previous page & try again");
		  	return;	
		}				
		try{
			String launch_time=""+year+"-"+month+"-"+day+" "+hour+":"+min+":00";
			java.util.Date now=new java.util.Date();
			int sec=0;
			java.util.Date launch=new java.util.Date(year-1900,month-1,day,hour,min,sec);
			...
			//ResultSet rs = null;
			stmt.executeUpdate("Update mail_campaign set launch_time='"+launch_time+"' where camp_id="+camp_id);
			stmt.executeUpdate("Update mail_campaign set camp_schd=1 where camp_id="+camp_id);
			out.println("<html>");
			out.println("<head>");
			...
			out.println("<tr>");
			out.println("<td width='100%'><font face='Verdana' color='#FFFFFF'><small><strong>Scheduled Campaign..</strong></small></font></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("</div><div align='right'>");
			...
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><font face='Verdana' color='#000080'><small><center><br>Campaign Successfully Scheduled.<br><br></small></font></td>");
			out.println("</tr>");
			out.println("<tr align='center'>");
