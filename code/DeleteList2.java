...
public class DeleteList2 extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		try{
            ...
            stmt.executeUpdate("Delete from global_list where list_id="+list_id);
			stmt.executeUpdate("Delete from camp_list where list_id="+list_id);
			stmt.executeUpdate("Delete from list_member where list_id="+list_id);
			out.println("<html>");
			out.println("<head>");
			...
			out.println("<tr>");
			out.println("<td width='100%'><font face='Verdana' color='#FFFFFF'><small><strong>Deleted List..</strong></small></font></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("</div><div align='right'>");
			...
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><font face='Verdana' color='#000080'><small><center><br>List Successfully Deleted.<br><br></small></font></td>");
			out.println("</tr>");
			out.println("<tr align='center'>");
