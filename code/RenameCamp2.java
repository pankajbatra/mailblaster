...
public class RenameCamp2 extends HttpServlet{
	...
	throws ServletException,IOException{
		...
		if(camp_name ==null)
		{
		  out.println("<H2>Campaign name may have been left empty</H2>");
		  out.println("<a href='javascript:history.go(-1)'>Click Here</a>  to go back to previous page & try again");
		  return;		
		}
		if(camp_name.equals(""))
		...
		try{
			...
			stmt.executeUpdate("Update mail_campaign set last_modi='"+last_modi+"',camp_name='"+camp_name+"' where camp_id="+camp_id);
			out.println("<html>");
			out.println("<head>");
			...
			out.println("<tr>");
			out.println("<td width='100%'><font face='Verdana' color='#FFFFFF'><small><strong>Renamed Campaign..</strong></small></font></td>");
			out.println("</tr>");
			out.println("</table>");
			out.println("</div><div align='right'>");
			...
			out.println("<td width='100%' height='27' valign='top' align='left' colspan='2'><font face='Verdana' color='#000080'><small><center><br>Campaign Successfully Renamed.<br><br></small></font></td>");
			out.println("</tr>");
			out.println("<tr align='center'>");
