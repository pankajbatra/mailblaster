...
public class ViewUnsub extends HttpServlet{
	...
	throws ServletException,IOException
	{
		...
		try{
			...
			out.println("<tr>");
			out.println("<td width='20%' bgcolor='#F3F3F3'><center><small><small><font face='Verdana'>S.No.</font></small></small></center></td>");
			out.println("<td width='40%' bgcolor='#F3F3F3'><center><small><small><font face='Verdana'>Name</font></small></small></center></td>");
			out.println("<td width='40%'><center><small><small><font face='Verdana'>Email Address</font></small></small></center></td>");
        	out.println("</tr>");
        	out.println("</table>");
        	out.println("</div>");
        	int co=0;
            ResultSet rs = stmt.executeQuery("Select * from list_member where list_id="+list_id+" AND member_unsub=1");
       		while(rs.next()){
        		...
        		out.println("<tr>");
        		out.println("<td width='20%' valign='middle' align='center' bgcolor='#FFFFFF'><font face='Verdana' color='#8000FF'><small><small><strong>"+(co+1)+"</strong></small></small></font></td>"); 		
        		out.println("<td width='40%' valign='middle' align='center' bgcolor='#FFFFFF'><font face='Verdana' color='#8000FF'><small><small><strong>"+name+"</strong></small></small></font></td>");
        		out.println("<td width='40%'valign='middle' align='center'><font face='Verdana' color='#8000FF'><small><small><strong>"+email+"</strong></small></small></font></td>");        		
        		out.println("</tr>");
        		out.println("</table>");
        		out.println("</div>");  
        		co++;      		        		
